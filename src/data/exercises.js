export const exercises = [
  {
    ...
    sections: {
      ...
      objectives: [
        "Identify all social media accounts associated with the target",
        "Create a timeline of the target's online activities",
      ...
      tools: [
        {
          name: "Sherlock",
          description: "Username search tool across multiple platforms",
          link: "https://github.com/sherlock-project/sherlock"
        },
        {
          name: "Social Analyzer",
          description: "Advanced social media profile analysis",
  ...
  {
    id: 2,
    title: "Find Jason Bichsels Address",
    description: "Learn how to analyze and track digital footprints through social media platforms.",
    difficulty: "medium",
    category: "Social Media",
    tags: ["social", "basic", "footprint", "tracking" ],
    points: 100,
    sections: {
      background: `In this exercise, you'll learn the fundamentals of analyzing social media profiles 
                  to gather intelligence. You'll be working with a REAL character's online presence I have consent for to do this
                  to practice safe and ethical OSINT techniques.`,
      objectives: [
        "Identify all social media accounts associated with the target",
        "Create a timeline of the target's online activities",
      ...
      tasks: [
        {
          id: 1,
          description: "Find the address of Jason Bichsel.",
          points: 25
        }
      ],
      hints: [
        {
          id: 1,
          text: "Just simply search for 'Jason Bichsel' in google.",
          isBlurred: true
        },
        {
          id: 2,
          text: "Check the socials that popup, for example linkedin.",
          isBlurred: true
        },
        {
          id: 3,
